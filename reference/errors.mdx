...
## Partner crypto payout custody (1820–1825)
...
| 1824 | `CRYPTO_PAYOUT_DUPLICATE_EXTERNAL_ID` | 409 | Re-using an `externalId`. Each merchant has a `(userId, externalId)` unique constraint — pick a fresh value per withdrawal. |
